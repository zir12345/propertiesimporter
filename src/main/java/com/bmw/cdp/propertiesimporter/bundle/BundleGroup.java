 ...
 */
package com.bmw.cdp.propertiesimporter.bundle;
   ...
   implements IBundleVisitable
{
   ...
   public void accept(IBundleVisitor visitor, Object passAlongArgument)
   {
      for (Iterator i = iterator(); i.hasNext();) {
         ...
         for (Iterator j = bundle.iterator(); j.hasNext();) {
            visitor.visitBundleEntry((BundleEntry)j.next(), passAlongArgument);
         }
   ...
   /**
    * Adds a bundle entry to the bundle in this group matching the given locale.
    * 
    * @param locale
    *        locale of bundle we want to add an entry to
    * @param bundleEntry
    *        the entry to add
    */
   ...
   /**
    * Adds a key to this group by creating a bundle entry with the given key and adding it to
    * each bundle.
    * 
    * @param key
    */
   ...
   /**
    * Renames the key in each bundle entry matching the <code>oldKey</code> to the
    * <code>newKey</code>.
    * 
    * @param oldKey
    *        key to replace
   ...
   /**
    * Copies each bundle entries matching the <code>origKey</code> under the <code>newKey</code>
    * .
    * 
    * @param origKey
    *        original key
   ...
   /**
    * Gets the bundle entry matching given key from the bundle matching the given locale.
    * 
    * @param locale
    *        locale of bundle in which to find the entry
    * @param key
    *        key of bundle entry.
    * @return bundle entry
    */
