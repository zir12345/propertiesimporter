   ...
   implements IBundleVisitable
{
    ...
    * 
    * @param key
    *        unique identifier within bundle
    * @param value
    *        entry value
    * @param comment
    *        entry comment
    * @param commented
    *        if this whole entry is considered commented out
    */
   ...
   public void accept(IBundleVisitor visitor, Object passAlongArgument)
   {
      ...
      if (bundle != null) {
         visitor.visitBundleGroup(bundle.getBundleGroup(), passAlongArgument);
      }
   }
   ...
   public boolean equals(Object obj)
   {
      ...
      return key.equals(entry.getKey())
             ...
             && (comment == null && entry.getComment() == null || comment != null
   ...
   {
      return super.toString() + "[[key=" + key //$NON-NLS-1$
