...
public final class PropertiesGenerator
{
   ...
   private static final int      NEW_LINE_UNIX            = 0;
   private static final int      NEW_LINE_WIN             = 1;
   private static final int      NEW_LINE_MAC             = 2;
   private static final int      GROUP_LINE_BREAKS        = 1;
   private static final int      GROUP_LEVEL_DEPTH        = 1;
   private static final String   KEY_GROUP_SEPERATOR      = ".";                                     //$NON-NLS-1$

   static {
      FORCED_LINE_SEP[NEW_LINE_UNIX] = "\\\\n"; //$NON-NLS-1$
      FORCED_LINE_SEP[NEW_LINE_WIN] = "\\\\r\\\\n"; //$NON-NLS-1$
      FORCED_LINE_SEP[NEW_LINE_MAC] = "\\\\r"; //$NON-NLS-1$
   }
   ...
   /**
    * Generates a formatted string from a given <code>Bundle</code>. The returned string will
    * conform to documented properties file structure.
    * 
    * @param bundle
    ...
    */
   private static void appendKey(StringBuffer text,
                                 String key,
                                 int equalIndex,
                                 boolean commented)
   {
    ...
    */
   private static void saveText(StringBuffer buf, String str, String escapeChars)
   {
      int len = str.length();
      for (int x = 0; x < len; x++) {
         char aChar = str.charAt(x);
   ...
   {
      String sep = KEY_GROUP_SEPERATOR;
      int deepness = GROUP_LEVEL_DEPTH;
      int endIndex = 0;
      int levelFound = 0;
   ...
   {
      int equalIndex = -1;
      boolean alignEquals = true;
      boolean groupKeys = true;
      boolean groupAlignEquals = true;
