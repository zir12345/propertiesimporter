...
/**
 * Finds bundle entries having values identical to the bundle entry given as the pass-along
 * argument.
 * 
 * @author Pascal Essiembre (essiembre@users.sourceforge.net)
 * @version $Author: essiembre $ $Revision: 1.1 $ $Date: 2005/07/30 04:30:16 $
 */
public class DuplicateValuesVisitor
   extends BundleVisitorAdapter
{
   ...
   public void visitBundleEntry(BundleEntry entry, Object passAlongArgument)
   {
      ...
      if (entry != entryToMatch && entry != null && entryToMatch != null
          && entry.getValue().length() > 0 && entry.getValue().equals(entryToMatch.getValue())) {
