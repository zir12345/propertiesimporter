...
public abstract class Model
{
   ...
   /*
    * The holder for listeners was changed from ListenerList to ArrayList to support both
    * Eclipse 3.1 and 3.2. The ListenerList location changed from 3.1 to 3.2 as described here:
